// src/components/voice/SpeakButton.jsx
// Small reusable speaker icon. Click to hear a message; click again while
// speaking to stop. Used on coach nudges and risk warnings.
  ...
  return (
    <button
      ...
      style={{
        ...
        background: speaking ? "var(--focus-dim, rgba(99,140,255,0.15))" : "var(--surface-raised)",
